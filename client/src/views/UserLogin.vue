      ...
      <main class="login-content">
        <div class="login-card">
          <header class="login-header">
            ...
            <p>Bienvenido de nuevo a Cougar Club</p>
          </header>
          ...
          <form class="login-form" @submit.prevent="handleLogin">
            ...
            <div class="form-options">
              ...
              <router-link to="/request-password-reset" class="forgot-password">¿Olvidaste tu contraseña?</router-link>
            </div>
            ...
            <p class="signup-link">
              ¿No tienes una cuenta? <router-link to="/signup">Crear cuenta</router-link>
            </p>
          </form>
        </div>
...
.signin-btn:hover {
  ...
  box-shadow: 0 4px 12px rgba(64, 133, 197, 0.3);
}
